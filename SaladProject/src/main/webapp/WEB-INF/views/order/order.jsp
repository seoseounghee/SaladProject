	    ...
	    <form action="${contextPath}/payment" method="post">
	        ...
	        <div class="info-block to">
	            <div class="line">
	                ...
	                <div class="line-content">
	                	<input type="text" name="username" id="username" value="${userVO.userName}" required/>
	            ...
	            <div class="line">
	                ...
	                <div class="line-content">
	                	<input type="text" name="useraddress" id="useraddress" value="${userVO.userAddress1} ${userVO.userAddress2}" required/>
	                </div>
	            </div>
	            <div class="line">
	                <div class="line-title"><label for="phoneNb">연락처</label></div>
	                <div class="line-content">
	                	<input type="text" name="userphone" id="userphoneNb" maxlength="11" value="${userVO.userPhone}" required/>
	                    <input type="text" name="ordererPhone" value="${userVO.userPhone}" hidden/>
	                </div>
	            </div>
	        </div>
	        <p class="h3">받는 사람 정보  
				<button type="button" id="copyButton" class="info-setting">구매자정보와 동일</button>
	        </p>
	        <div class="info-block to">
	            <div class="line">
	                <div class="line-title"><label for="name">이름</label></div>
	                <div class="line-content">
	                	<input type="text" name="destName" id="name" placeholder="받으실 분의 이름을 입력하세요" required/>
	                </div>
	            </div>
	            <div class="line">
	                <div class="line-title"><label for="address">배송주소</label></div>
	                <div class="line-content">
	                	<input type="text" name="destLoc" id="address" placeholder="배송주소를 입력하세요" required/>
	                </div>
	            </div>
	            <div class="line">
	                <div class="line-title"><label for="phoneNb">연락처</label></div>
	                <div class="line-content">
	                	<input type="text" name="destPhone" id="phoneNb" maxlength="11" placeholder="'-' 없이 입력하세요" required/>
	                </div>
	            </div>
	            <div class="line">
	        ...
	        <div class="info-block">
	            ...
	            <div class="line">
	                ...
	                <div class="line-price" style="color: #d12420;">
	                	<fmt:formatNumber value="${totalPrice+shippingCost}" pattern="###,###원"/></div>
	            </div>									
	            <div class="line">
	                <div id="radioLine"class="line-title">결제방법</div>
	                <div class="line-content">
	                    <div class="line pay option">
