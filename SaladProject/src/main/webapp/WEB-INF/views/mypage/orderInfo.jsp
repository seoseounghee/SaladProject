...
<head>
    ...
    <!-- 서승희: 사이드 css 맞추기 위해 추가(23.07.30.)  -->
    ...
    <div class="odl-container">
        ...
        <table class="order-info-table" align="center">
            <tr>
                ...
                <td class="order-info-td" colspan="1"><input class="content_input" type="text" value="${orderInfo.fakeOrderNum}" disabled/></td>
            </tr>
            <tr>
                <td class="order-info-td-title">주문일자</td>
                <td class="order-info-td"><input class="content_input" type="text" value="${orderInfo.orderCreateTimestamp}" disabled/></td>
            </tr>
            <tr>
                <td class="order-info-td-title oi-border-top">배송 예정 일자</td>
                <td class="order-info-td"><input class="content_input" type="text" value="${orderInfo.prodDeliveryDate}" disabled/></td>
            </tr>
            <tr>
                <td class="order-info-td-title">주문자 이름</td>
                <td class="order-info-td"><input class="content_input" type="text" value="${orderInfo.ordererName}" disabled/></td>
            </tr>
            <tr>
                <td class="order-info-td-title">주문 상태</td>
                <td class="order-info-td"><input class="content_input" type="text" value="${orderInfo.orderStatus}" disabled/></td>
            </tr>
            <tr>
